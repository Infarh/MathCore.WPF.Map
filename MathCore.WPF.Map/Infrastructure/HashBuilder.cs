...
internal readonly ref struct HashBuilder
{
    ...
    public HashBuilder HashBase(int Base) => new HashBuilder(_Hash, Base);
    ...
    {
        var HashBase = _HashBase == 0 ? 397 : _HashBase;
        return new HashBuilder(_Hash * HashBase ^ hash, HashBase);
    }
